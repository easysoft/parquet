...
final class Writer
{
     ...
     */
    private $compression = Compressions::UNCOMPRESSED;
    /**
    ...
    /**
     * @var \Flow\Parquet\ParquetFile\RowGroupBuilder|null
     */
    private $rowGroupBuilder;
    ...
    public function openForStream($resource, Schema $schema) : void
    {
        ...
        if (strncmp($streamMetadata['mode'], 'w', strlen('w')) !== 0) {
