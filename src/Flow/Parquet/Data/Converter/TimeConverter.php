...
final class TimeConverter implements Converter
{
     ...
     * @param mixed $data
     */
    public function fromParquetType($data) : \DateInterval
    {
    ...
    {
        if ($column->type() === PhysicalType::INT64 && (($nullsafeVariable1 = $column->logicalType()) ? $nullsafeVariable1->name() : null) === LogicalType::TIME) {
            return true;
        }
