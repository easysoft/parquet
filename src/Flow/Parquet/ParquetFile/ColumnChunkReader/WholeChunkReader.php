...
final class WholeChunkReader implements ColumnChunkReader
{
    /**
     * @readonly
     * @var \Flow\Parquet\ParquetFile\Data\DataBuilder
     */
    private $dataBuilder;
    /**
     * @readonly
     * @var \Flow\Parquet\ParquetFile\PageReader
     */
    private $pageReader;
    public function __construct(DataBuilder $dataBuilder, PageReader $pageReader)
    {
