...
final class Flattener
{
    /**
     * @readonly
     * @var \Flow\Parquet\ParquetFile\RowGroupBuilder\Validator
     */
    private $validator;
     ...
     */
    private function flattenList(NestedColumn $column, $columnData) : array
    {
     ...
     * @param mixed $columnData
     */
    private function flattenMap(NestedColumn $column, $columnData) : array
    {
     ...
     * @param mixed $columnData
     */
    private function flattenStructure(NestedColumn $column, $columnData) : array
    {
        $data = [];
